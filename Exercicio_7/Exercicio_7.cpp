...
int main(int argc, char **argv)
{
    ...
    glutMotionFunc(MousePosition);                         // Verifica a posicao do mouse quando o botão esquerdo está pressionado
    glutPassiveMotionFunc(MousePassiveMotion);             // Verifica a posicao do mouse quando nenhum botão está pressionado
